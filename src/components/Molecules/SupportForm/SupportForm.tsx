            ...
            <form onSubmit={handleSubmit} className="form">
                <div className="container-md  main__section">
                    ...
                    <div className="create__section">
                        ...
                        <TextArea label={t("supportForm.form.message")} name="text" maxLength={300} required={true} />
                    </div>
                    <Submit label={t("supportForm.form.submit")} className='btn--primary' onClick={handleClick} />
                </div>
            </form >
